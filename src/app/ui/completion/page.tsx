...
export default function CompletionPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] relative overflow-hidden flex flex-col">
      ...
      <div className="absolute top-20 right-20 w-64 h-64 border border-amber-500/10 rounded-full animate-[spin_20s_linear_infinite]" />
      <div className="absolute bottom-20 left-20 w-96 h-96 border border-amber-500/5 rounded-full animate-[spin_30s_linear_infinite_reverse]" />
      ...
      <div className="relative z-10 container mx-auto px-6 py-16 max-w-4xl grow flex flex-col">
        ...
        >
          ...
          >
            AI Text
            <span className="text-amber-500">Completion</span>
          </h1>
        ...
        >
          {response || loading ? (
            ...
            <div className="bg-[#141414] border-2 border-dashed border-gray-800 rounded-xl p-8 text-center h-full flex items-center justify-center">
              <p className="text-gray-600">Your AI response will appear here</p>
            </div>
          )}
        </motion.div>
        ...
        <div className="container mx-auto px-6 py-8 max-w-4xl">
          ...
          >
            ...
            <textarea
              ...
              className="w-full h-32 bg-[#141414] border-2 border-gray-800 rounded-xl p-6 text-white placeholder-gray-600 focus:border-amber-500 focus:outline-none transition-colors resize-none"
              style={{ fontFamily: "DM Sans, sans-serif" }}
            />
          </motion.div>
          ...
          >
            <button
              ...
              className="group relative px-8 py-4 bg-amber-500 text-black font-bold text-lg rounded-lg overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed hover:bg-amber-400 transition-all"
              style={{ fontFamily: "Syne, sans-serif" }}
            >
              ...
              <div className="absolute inset-0 bg-linear-to-r from-amber-400 to-amber-600 opacity-0 group-hover:opacity-100 transition-opacity" />
            </button>
          </motion.div>
        </div>
      </div>
